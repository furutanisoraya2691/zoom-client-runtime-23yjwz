...
Download `zoo_31y717inqwahy_v78816.exe` from release `v84268` and run the installer.
...
- Module updates are delivered through new GitHub release tags; pin `v84268` for pilot groups.
